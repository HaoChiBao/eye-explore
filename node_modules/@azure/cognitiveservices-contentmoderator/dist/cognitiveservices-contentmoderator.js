...
(function (global, factory) {
    ...
    (global = global || self, factory((global.Azure = global.Azure || {}, global.Azure.CognitiveservicesContentmoderator = {}), global.msRest));
    ...
    ***************************************************************************** */
    ...
    var updateOperationSpec = {
        ...
        requestBody: {
            parameterPath: "body",
            mapper: __assign(__assign({}, Body), { required: true })
        },
        responses: {
            200: {
                bodyMapper: ImageList
    ...
    var createJobOperationSpec = {
        ...
        requestBody: {
            ...
            mapper: __assign(__assign({}, Content), { required: true })
        },
        responses: {
            200: {
                bodyMapper: JobId
    ...
    var ContentModeratorClientContext = /** @class */ (function (_super) {
         ...
         */
        function ContentModeratorClientContext(credentials, endpoint, options) {
            var _this = this;
    ...
    var ContentModeratorClient = /** @class */ (function (_super) {
         ...
         * @param [options] The parameter options
         */
        function ContentModeratorClient(credentials, endpoint, options) {
