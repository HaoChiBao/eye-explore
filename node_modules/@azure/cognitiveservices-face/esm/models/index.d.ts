 ...
 * @enum {string}
 */
export declare type QualityForRecognition = 'Low' | 'Medium' | 'High';
/**
 ...
 * @enum {string}
 */
export declare type FaceAttributeType = 'age' | 'gender' | 'headPose' | 'smile' | 'facialHair' | 'glasses' | 'emotion' | 'hair' | 'makeup' | 'occlusion' | 'accessories' | 'blur' | 'exposure' | 'noise' | 'mask' | 'qualityForRecognition';
/**
